...
import java.util.Scanner;
	...
	public class BankSystem {
	    public static void main(String[] args) {
	        ...
	        SavingsAccount savingsAccount = new SavingsAccount("SA001", "Abhay Mallick", 1000.0);

	        // Create current account
	        CurrentAccount currentAccount = new CurrentAccount("CA001", "Abhay Mallick", 2000.0);
	        System.out.println("*** welcome to Anuradha Laxmi Cheat Funds Bank ***");
